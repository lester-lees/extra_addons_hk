...
class stock_tmijdi_picking(report_sxw.rml_parse):
    ...
    def group_lines_by_coe(self, o=None):	 # 此函数不分组
        res = {}		
        ...
        for line in move_lines:
            ...
            res[tmi_jdi_no]['lines'].append(line_value)		
			
        return res			
		
    def _group_lines_by_coe(self, o=None):	 # 此函数把 同一个客户的 多个电商订单合并到一组，  在拣货单PDF文件中，以一组显示
        res = {}
        tmi_jdi_list = []		
        move_lines = o.move_lines.sorted(key=lambda r: r.coe_no)		
